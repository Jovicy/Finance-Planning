        ...
        <div className="custom-container flex flex-col gap-12">
          ...
          >
            {teams.map((team) => (
              ...
              >
                <div>
                  <img src={team.image} alt={team.name} className="rounded-md" />
                </div>
                <div>
      ...
      >
        <div className="custom-container flex justify-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h1 className="text-5xl font-bold mb-2">Get Started Today With Us</h1>
            <p className="text-sm">
              This is a Revolutionary Money Making Platform! Invest for Future in
              Stable Platform and Make Fast Money. Not only we guarantee the
